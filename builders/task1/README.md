...
# Задача №2: "Многомодульный проект на Maven" (со звездочкой * )

Создать реализацию хранения entity с помощью Map. Формат хранения выбрать самим. 

Реализовать класс в модуле api аналогичный, как в service. Продумать методы добавления, обновления и удаления entity.

Суть в том, что хренение данных находится в модуле db, а вызовы для методов - в модуле api. 
