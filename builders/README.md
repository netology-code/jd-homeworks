...
1. [Многомодульный проект на Maven](./task1/README.md) (обязательное + задание со звездочкой *);
2. [Многомодульный проект на Gradle](./task2/README.md)(обязательное + задание со звездочкой *).
