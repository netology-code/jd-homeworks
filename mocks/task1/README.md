...
## Описание
В репозитории [cервис отправки сообщений](https://github.com/neee/geo-service) находится код приложения отправки локализованных сообщений, в котором на основе ip-адреса в переданных заголовках, определяется язык отправляемого сообщения.
