...
Освоим на практике материал, который был пройден на лекции. В результате выполнения этого задания вы:
- Научитесь использовать потокобезопасные коллекции для общения потоков друг с другом

## Задание

Необходимо выполнить и предоставить на проверку следующие задачи:

1. [Колл-центр](./task1/README.md);	
