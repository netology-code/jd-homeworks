...
Итак, давайте немного попрактикуем материал, который был пройден на лекции. В результате выполнения этого задания вы:
- Научитесь запускать потоки, превращая однопоточную программу в многопоточную;
- Научитесь правильно управлять запущенными потоками;
- Научитесь считать значения в отдельных потоках. 
...
2. [Максимальный интервал значений](./task2/README.md) (со звездочкой *).
