...
4. [Дженерик с имплементацией интерфейса](./task4/README.md);
5. [Дженерик с wildcard аргументами](./task5/README.md)* (необязательна к выполнению).
...
1. Пишите код в IDE (рекомендуем [Intellij IDEA](https://www.jetbrains.com/idea/download/), версия Community).
    ...
    1. Почему Intellij IDEA? — она бесплатная, умная, большинство разработчиков пользуются именно ей.
