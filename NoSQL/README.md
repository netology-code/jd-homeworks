...
- Установлена среда разработки IDE.
...
### Формат сдачи работы:
1. Пишите код в IDE (например [OpenIDE](https://openide.ru/)). [Инструкция по установке IDE](https://github.com/netology-code/jspr-homeworks/blob/master/idea-installation.md). 
