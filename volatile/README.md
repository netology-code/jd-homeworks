# Домашнее задание к занятию 1.3 Работа с синхронизацией. Synchronized блоки. Методы wait, notify, sleep. Интерфейс lock.

Итак, давайте немного попрактикуем материал, который был пройден на лекции.

Необходимо выполнить и предоставить на проверку следующие задачи:

1. [Самая бесполезная коробка](./task1/README.md);	
2. [Отчет для налоговой](./task2/README.md);
