...
- Научитесь пользоваться средствами синхронизации для возможности работы потоков в небезопасном race condition
...
2. [Продвинутый автосалон](./task2/README.md) (со звездочкой *).
